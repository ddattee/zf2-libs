 ...
 * @method FootScript appendFile($src, $type = 'text/javascript', $attrs = array())
 * @method FootScript offsetSetFile($index, $src, $type = 'text/javascript', $attrs = array())
 * @method FootScript prependFile($src, $type = 'text/javascript', $attrs = array())
 * @method FootScript setFile($src, $type = 'text/javascript', $attrs = array())
 * @method FootScript appendScript($script, $type = 'text/javascript', $attrs = array())
...
class FootScript extends View\Helper\Placeholder\Container\AbstractStandalone
{
     ...
     * @var string
     */
    protected $regKey = 'Zend_View_Helper_FootScript';
    ...
    /**
     * Return feadScript object
     *
     * Returns feadScript helper object; optionally, allows specifying a script
    ...
    public function captureStart(
        ...
        if ($this->captureLock) {
            throw new Exception\RuntimeException('Cannot nest feadScript captures');
        }
